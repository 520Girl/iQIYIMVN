...
export function useGetList() {
	const { name, path, params: type_param, query: type_query } = toRefs(useRoute())
	...
	const getList = async (params: ListTypesParams) => {
		...
		console.log("========================", type_param, type_query, query, params)
		if (type_param && name.value !== "play-type_id-vod_id") {
